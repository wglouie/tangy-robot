...
std::string tangyRobot::detect_face() {
...
//the publisher is defined in tangyRobot.h and the advertising of the publisher is done int the tangyRobot.cpp
void tangyRobot::changePOI()
{
...
void tangyRobot::stopNeckMovement(bool stopneckmove)
{
  string neckmove;
  if(stopneckmove)
	neckmove="trueess";
...
void tangyRobot::stop_look_at_face(){
