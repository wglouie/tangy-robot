...
#skype.Client.WindowState = Skype4Py.wndNormal
#skype.Client.WindowState = Skype4Py.wndMaximized

window = gtk.Window()
screen = window.get_screen()
print "width = " + str(screen.get_width()) + ", height = " + str(screen.get_height())
b = str(screen.get_width())
c = str(screen.get_height())
a = '1,0,0,'+ b + ','+ c
#CallStatus = Skype4Py.clsFinished
time.sleep(2)
subprocess.call(["wmctrl", "-a", "Call"])
subprocess.call(["wmctrl", "-r", "Call", "-e", a])#"1,0,0,str(screen.get_width()),str(screen.get_height())"])
