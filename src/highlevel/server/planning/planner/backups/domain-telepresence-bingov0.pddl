(define (domain MultiActivityDomainv4)
    (:requirements :typing :fluents :negative-preconditions :equality :quantified-preconditions :durative-actions :timed-initial-literals :disjunctive-preconditions)
    (:types
      Location - object
      Mobile - object
      Robot - Mobile
