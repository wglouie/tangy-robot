...
int main(int argc , char **argv)
{
	...
	ROS_INFO("Initializing markers_from_tf node...");
	...
	while(ros::ok())
	{
		...
		//{
			...
			try
			{
				...
				tf_listener.lookupTransform(fixed_frame, "/skeleton/head_1"/*skeleton_frames[i]*/, ros::Time(0), transform);
		...
		//}
		ROS_INFO("%d points were added",added_points);
