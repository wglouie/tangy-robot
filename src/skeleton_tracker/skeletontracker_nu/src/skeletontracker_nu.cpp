...
public:
    ...
    status_pub = nh_.advertise<std_msgs::Int8> ("skeletontracker_nu/status", 100);
...
//---------------------------------------------------------------------------
    ...
    void publishData(void)
	{
        ...
        std_msgs::Int8 num_skels_msg;
        num_skels_msg.data = users_count;
        status_pub.publish(num_skels_msg);
