...
public:
    IR_RGB_Streamer(): it_(nh){
        rgb_sub = it_.subscribe("/bottom_camera/rgb/image_raw", 1, &IR_RGB_Streamer::rgb_image_cb, this);
    }
    ...
    void rgb_image_cb(const sensor_msgs::ImageConstPtr& msg){
        ...
        rgb_sub.shutdown();
        ir_sub = it_.subscribe("/bottom_camera/ir/image_raw", 1, &IR_RGB_Streamer::ir_image_cb, this);
